...
<!--                                <h6 class="ribbon-cont"><div class="ribbon primary"></div><b>OFFER</b></h6>-->
                                <img style="border-radius:50%;" src="<?php echo $image['url'];?>" alt="">
                            </div>
                        ...
                        <ul class="selecton brdr-b-primary mb-70">
                            <?php while( have_rows('our_menu') ): the_row();
                                ...
                                ?>
                                    ...
                                    <li><a class="active" href="#" data-select="<?php echo sanitize_title($category_name);?>">
            ...
            <?php while( have_rows('category') ): the_row();
                ...
                ?>
                            <div class="sided-90x mb-30 ">
                                <div class="s-left"><img class="br-3" src="<?php echo $image['url'];?>" alt="<?php echo $title;?>"></div><!--s-left-->
                                <div class="s-right">
                                    <h5 class="mb-10"><b><?php echo $title?></b></h5>
